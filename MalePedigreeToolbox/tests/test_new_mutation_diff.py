...
class TestMutationDiff(TestCase):
    ...
    def test_get_optimal_nr_mutations1(self):
        ...
        l1 = [48, 66.1, 67.1]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 4),  [[0, 0, 1, 0]])

    def test_get_optimal_nr_mutations2(self):
        l2 = [48, 66.1]
        l1 = [48, 66.1, 67.1]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 5),  [[0, 0, 1, 0, 0]])

    def test_get_optimal_nr_mutations3(self):
        l1 = [12]
        l2 = [13]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 2),  [[1, 1]])

    def test_get_optimal_nr_mutations4(self):
        l1 = [55, 63.1, 67.1]
        l2 = [54, 55, 63.1]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 4),  [[0, 0, 4, 1]])
    ...
    def test_get_optimal_nr_mutations5(self):
        ...
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 3),  [[0, 0, 4, 1]])

    def test_get_optimal_nr_mutations6(self):
        l1 = [1, 0, 0, 0, 0]
        l2 = [4, 0, 0, 0, 0]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 1),  [[3]])

    def test_get_optimal_nr_mutations7(self):
        l1 = [12, 13, 18]
        l2 = [12, 18]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 3),  [[0, 1, 0]])

    def test_get_optimal_nr_mutations8(self):
        l1 = [12, 13, 14]
        l2 = [12]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 3),  [[0, 1, 2]])
    ...
    def test_get_optimal_nr_mutations9(self):
        ...
        diff = mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 3)
    ...
    def test_get_optimal_nr_mutations10(self):
        ...
        l2 = [12, 18]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 4),  [[0, 1, 0, 1]])

    def test_get_optimal_nr_mutations11(self):
        l1 = [12, 13, 16]
        l2 = [13, 12, 16]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 3),  [[0, 0, 0]])
    ...
    def test_get_optimal_nr_mutations15(self):
        ...
        l2 = [13]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 3),  [[1, 1, 1]])

    def test_get_optimal_nr_mutations16(self):
        l1 = [12, 15]
        l2 = [13, 15]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 3),  [[1, 0, 0]])
    ...
    def test_get_optimal_nr_mutations18(self):
        ...
        l2 = [12.1, 13]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 2),  [[1, 0]])

    def test_get_optimal_nr_mutations19(self):
        l1 = [12.1, 11]
        l2 = [11.1, 12.1, 11, 12]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 4),  [[1, 0, 0, 1]])
    ...
    def test_get_optimal_nr_mutations21(self):
        ...
        l2 = [0]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 1),  [[0]])

    def test_get_optimal_nr_mutations22(self):
        l1 = [10]
        l2 = [0]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 1),  [[10]])

    def test_get_optimal_nr_mutations23(self):
        l1 = [21]
        l2 = [22]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 1),  [[1]])
    ...
    def test_get_optimal_nr_mutations26(self):
        ...
        l1 = [48, 66.1]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 4),  [[0, 0, 0, 0]])

    def test_get_optimal_nr_mutations27(self):
        l1 = [16.2, 19.2]
        l2 = [16.2, 18.2, 19.2]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 4),  [[0, 1, 0, 0]])
    ...
    def test_get_optimal_nr_mutations30(self):
        ...
        l2 = [12, 13]
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 4),  [[0, 0, 5, 0]])
    ...
    def test_get_optimal_nr_mutations32(self):
        ...
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2"), ("l1", "l3")], mapping, 3),
                             [[0, 0, 1], [0, 1, 1]])
    ...
    def test_get_optimal_nr_mutations34(self):
        ...
        mapping = {"l1": l1, "l2": l2}
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2")], mapping, 4),  [[0, 0, 3, 1]])
    ...
    def test_get_optimal_nr_mutations36(self):
        ...
        self.assertListEqual(mutation_diff.get_optimal_nr_mutations([("l1", "l2"), ("l3", "l4")], mapping, 3),
                             [[0, 0, 1], [1, 1, 1]])
